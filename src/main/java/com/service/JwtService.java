...
public class JwtService {
    ...
    // Ideally, the secret key should be stored in environment variables for security reasons
    ...
    // Validate the token against user details and check if it's expired
